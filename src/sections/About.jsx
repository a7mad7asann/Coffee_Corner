...
export default function About() {
  ...
  return (
    <section
      className="relative overflow-hidden bg-[#fff8ef] py-16 mt-20"
      dir={lang === "ar" ? "rtl" : "ltr"}
    >
      <div className="absolute inset-0 bg-[url('/images/about_pattern.webp')] bg-repeat opacity-[0.06]" />
      ...
      <motion.div
        className="relative mx-auto mt-10 grid w-full max-w-7xl grid-cols-1 gap-4 px-4 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8 will-change-opacity"
      ...
      >
        {content.values.map((value) => (
          <div
            key={value.title}
            className="rounded-lg border border-[#ead8ca] bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md"
          >
            ...
            <h3 className="font-black text-[#2f2118]">{value.title}</h3>
