...
export default function Navbar() {
  ...
  const content = data?.navbar?.[lang] || null;
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl justify-between items-center h-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/cart"
            aria-label={lang === "ar" ? "عرض السلة" : "View cart"}
            className="relative p-2 transition duration-300 hover:text-orange-500"
          >
