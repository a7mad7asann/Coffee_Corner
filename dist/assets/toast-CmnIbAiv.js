...
to {
  ...
  animation: ${ue} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,fe=({toast:e})=>{let{icon:t,type:r,iconTheme:i}=e;return t!==void 0?typeof t=="string"?c.createElement(pe,null,t):t:r==="blank"?null:c.createElement(ce,null,c.createElement(ie,{...i}),r!=="loading"&&c.createElement(de,null,r==="error"?c.createElement(re,{...i}):c.createElement(le,{...i})))},me=e=>`
